...
Route::get('devices_list_sensors', [DeviceController::class, 'devicesDropdownListSensors']);
...
Route::get('get_device_settings_from_cache', [DeviceController::class, 'getDeviceConfigSettingsFromCache']);
...
Route::post('/update_sos_devices_to_eviceConfig', [DeviceController::class, 'updateSOSDevicesToDeviceConfig']);

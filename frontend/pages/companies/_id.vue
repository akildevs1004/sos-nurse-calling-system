                  ...
                  <v-card-text>
                    <v-row>
                      <v-col cols="3" md="3" sm="3">
                        ...
                        <v-text-field color="grey" readonly dense filled outlined
                      ...
                      <v-col cols="3" md="3" sm="3">
                        ...
                        <span class="text-danger">*</span>
                        <v-text-field color="grey" filled readonly dense outlined
...
<v-date-picker v-model="company_trade_license.issue_date" @input="menuIssueDate = false"></v-date-picker>
</v-menu>
...
<v-col cols="6">
  ...
  <span class="text-danger">*</span>
  <v-menu v-model="menuExpiryDate" :close-on-content-click="false" :nudge-right="40" transition="scale-transition"
    ...
    <v-date-picker v-model="company_trade_license.expiry_date" @input="menuExpiryDate = false"></v-date-picker>
  </v-menu>
...
<v-col cols="12">
  <div class="text-right">
    <v-btn v-if="can('company_edit')" small :loading="loading" color="primary" @click="update_license">
      Submit
    </v-btn>
  </div>
</v-col>
